    ...
    <div>
      ...
      <div className={styles.mainWraper}>
        ...
        <div>
          ...
          {
            toggle?<p className={styles.aboutMe}> My name is Tianwei, you can also call me Cedric. I am a second year Web Design Student in Durham College who loves coding and learns new technology a lot. Prior to the program, I had gone through years in finding what I really want to do.
        ...
        <div>
          <img src={require('../../assets/avatar.jpg')} className={styles.myPhoto}></img>
        </div> 
