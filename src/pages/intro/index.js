    ...
    <div>
      ...
      <div className={styles.mainWraper}>
        ...
        <div>
          ...
          {
            toggle?<p className={styles.aboutMe}>My name is Tianwei Wang, you can also call me Cedric. I am a second year Web Design Student in Durham College and I am especially interested in coding with both Vanilla Javascript and React. Prior to the program, I had gone through years in finding what I really want to do.
            ...
            do I really want to idle my whole life doing the basic, unprofessional work with little growth?   I wouldn't allow my life being that way, so one year later, I quit my job and came to Canada to start my new life from scratch. 
            </p> : <p className={styles.aboutMe}>I am a big fan of travelling around the world and I am quite interested in the world, as science, technology, medicine, economy, modern political system, all the advanced civilization we enjoy today all have their trace of struggle, development and thriving etched in the world map along our long history. Beside coding, I love getting to know more about science, technology
                    ...
                    just like a historical relay race. Although the place where I come from unfortunately hasn't been fully nourished by the light of modern civilization, but my pursuit of freedom is what's making me a real human-being and the reason you know me. Hope to see you soon. </p>
          }
